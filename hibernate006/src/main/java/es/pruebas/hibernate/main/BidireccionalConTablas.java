...
import es.pruebas.hibernate.model.bidireccional.contablas.Cliente;
import es.pruebas.hibernate.model.bidireccional.contablas.Factura;
import es.pruebas.hibernate.model.bidireccional.contablas.LineaFactura;
import es.pruebas.hibernate.model.bidireccional.contablas.OperacionContable;
import es.pruebas.hibernate.model.bidireccional.contablas.Responsable;

public class BidireccionalConTablas {
