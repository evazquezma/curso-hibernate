...
import es.pruebas.hibernate.model.unidireccional.sintablas.Continente;
import es.pruebas.hibernate.model.unidireccional.sintablas.Pais;
import es.pruebas.hibernate.model.unidireccional.sintablas.Presidente;
import es.pruebas.hibernate.model.unidireccional.sintablas.Provincia;

public class UnidireccionalSinTablas {
	...
	public void run() {
		...
		Pais pais = new Pais();
		pais.setContienente(obtenerContiente(session));
